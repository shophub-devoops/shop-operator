...
func init() { // da ovde nemamo scheme client nebi mogao da serijalizuje ove tipove
	// bez ovoga nebi mogli da pravimo npr CNPG cluster ili mongo resurse, moramo da ih registrujemo
