...
import (
	...
	appscontroller "github.com/shophub-devoops/shop-operator/internal/controller/apps"
	notifycontroller "github.com/shophub-devoops/shop-operator/internal/controller/notify"
	paymentscontroller "github.com/shophub-devoops/shop-operator/internal/controller/payments"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cef76b98.shophub.local",
	...
	if err := (&appscontroller.ShopReconciler{
	...
	if err := (&notifycontroller.DiscordChannelReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err := (&paymentscontroller.WalletReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
